...
export class CustomerComponent implements OnInit {
  ...
  drivers: Driver[] = []
  tempDrivers: Driver[] = []
  constructor(private actRouter: ActivatedRoute, private _customerService: CustomerService, private router:Router, private _loginService:LoginService) { }
  ...
  logOut(){
    this._customerService.customerLogout();
